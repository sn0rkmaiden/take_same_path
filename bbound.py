...
#Builds a solution using the next neighbor heuristic
...
def build_solution():
    ...
    while currentIndex < NB_TOWNS:
        ...
        #Test if cycle is hamiltonian
        for i in range(currentIndex):
            if solution[i] == currentNode:
                #print("Cycle non-hamiltonian")
                return
...
def branch_and_bound(dist, iteration, evalParentNode):
    ...
    #Subtracting min value of columns 
